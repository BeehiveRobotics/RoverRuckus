...
class ControllerTest: BROpMode(OpModeType.TeleOp) {
    ...
    override fun run() {
        ...
        addData("Dpad up", controller1.dpadUp.toString())
        addData("Dpad down", controller1.dpadDown.toString())
        addData("Dpad left", controller1.dpadLeft.toString())
        addData("Dpad right", controller1.dpadRight.toString())
        ...
        addData("Dpad up toggle", controller1.dpadUpToggle.toString())
        addData("Dpad down toggle", controller1.dpadDownToggle.toString())
        addData("Dpad left toggle", controller1.dpadLeftToggle.toString())
        addData("Dpad right toggle", controller1.dpadRightToggle.toString())
